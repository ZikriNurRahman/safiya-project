            ...
            <div className="flex items-start gap-x-8">
              <div className="flex items-start gap-x-1 w-full">
                <div className="flex flex-col w-1/3" data-testid="shipping-address-summary">
                  <Text className="txt-medium-plus text-ui-fg-base mb-1">Alamat Pengiriman</Text>
                ...
                <div className="flex flex-col w-1/3" data-testid="shipping-contact-summary">
                  <Text className="txt-medium-plus text-ui-fg-base mb-1">Kontak</Text>
                ...
                <div className="flex flex-col w-1/3" data-testid="billing-address-summary">
                  <Text className="txt-medium-plus text-ui-fg-base mb-1">Alamat Penagihan</Text>
                  {sameAsBilling ? (
                    <Text className="txt-medium text-ui-fg-subtle">Sama dengan alamat pengiriman.</Text>
                  ) : (
                    <>
                      <Text className="txt-medium text-ui-fg-subtle">
